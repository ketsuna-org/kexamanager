...
export default function Nodes(){
  ...
  return (
    <div>
      ...
      <Typography variant="body2" gutterBottom>{t('dashboard.nodes_desc')}</Typography>
                        ...
                        <TableRow hover>
                          <TableCell sx={{ width: 48 }}>
                            <IconButton
                              ...
                              size="small"
                              onClick={() => setExpanded((prev: Record<string, boolean>) => ({ ...prev, [n.id]: !prev[n.id] }))}
                            >
                          ...
                          <TableCell>
                            {n.error ? (
                              <Typography color="error" variant="body2">{n.error}</Typography>
                            ) : '-'}
                          </TableCell>
                        </TableRow>
                        <TableRow>
