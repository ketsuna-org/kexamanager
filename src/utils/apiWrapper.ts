...
function LaunchRepairOperation(params: { node?: string } = {}, data: components["schemas"]["LocalLaunchRepairOperationRequest"]): Promise<components["schemas"]["MultiResponse_LocalLaunchRepairOperationResponse"]> {
  const node = params.node ?? "*"
...
function GetWorkerVariable(params: { node?: string } = {}, data: components["schemas"]["LocalGetWorkerVariableRequest"]): Promise<components["schemas"]["MultiResponse_LocalGetWorkerVariableResponse"]> {
  const node = params.node ?? "*"
  return adminPost<components["schemas"]["MultiResponse_LocalGetWorkerVariableResponse"]>("/v2/GetWorkerVariable", data, { query: { node } });
}

function SetWorkerVariable(params: { node?: string } = {}, data: components["schemas"]["LocalSetWorkerVariableRequest"]): Promise<components["schemas"]["MultiResponse_LocalSetWorkerVariableResponse"]> {
  const node = params.node ?? "*"
